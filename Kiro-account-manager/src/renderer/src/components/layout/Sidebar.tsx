import { Home, Users, Settings, Info, ChevronLeft, ChevronRight, Fingerprint, Sparkles, Server, Shield, UserPlus } from 'lucide-react'
...
export type PageType = 'home' | 'accounts' | 'autoRegister' | 'machineId' | 'kiroSettings' | 'proxy' | 'kproxy' | 'settings' | 'about'
...
const menuItemsConfig: { id: PageType; labelKey: string; icon: React.ElementType }[] = [
  ...
  { id: 'autoRegister', labelKey: 'nav.autoRegister', icon: UserPlus },
